...
/**********************************************************\
|                                                          |
| Modified by Ole Friis February 15, 2019:                 |
| Removed prepending the data to be encrypted with the     |
| actual data length.                                      |
|                                                          |
\**********************************************************/
namespace Eco2.Encryption
{
    ...
    public sealed class XXTEA
    {
        ...
        public static Byte[] Encrypt(Byte[] data, Byte[] key)
        {
            ...
            return ToByteArray(Encrypt(ToUInt32Array(data), ToUInt32Array(FixKey(key))));
        }
        ...
        public static Byte[] Decrypt(Byte[] data, Byte[] key)
        {
            ...
            return ToByteArray(Decrypt(ToUInt32Array(data), ToUInt32Array(FixKey(key))));
        }
